...
const Footer = () => {
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} ${styles.paddingX} flex-col border-t-[1px] border-t-[#1d1f32]`}>
    ...
    <div className="flex flex-row md:mt-0 mt-6">
      ...
      <p className="text-center text-[14px] text-white">
        Copyright Ⓒ 2023 DaddyLoyal. All Rights Reserved.
      </p>
