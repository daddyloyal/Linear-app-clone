  ...
  return (
    ...
    >
      ...
      <div className="feature-title max-w-screen-md ">
        <h1 className="text-4xl md:text-5xl  lg:text-6xl py-4 break-words max-w-md font-bold text-center text-white mx-auto">
          Unlike any tool you’ve used before
        </h1>
        <p className="text-[26px] leading-tight py-2 text-center text-slate-200 break-words max-w-2xl mb-8">
