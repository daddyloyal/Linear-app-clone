...
const Workflow = () => {
  return (
    ...
    id="workflow">
        {/* Title */}
      <div
        className={`flex-1 ${styles.flexStart} flex-col w-full min-h-[300px] xl:px-0 sm:px-16 px-6 h-14 bg-gradient-to-b from-primary  via-purple-900 to-primary shadow-lg shadow-primary rounded`}
      >
      ...
      <div className="mx-auto">
        <div className="images w-[200px] rounded-full border-slate-500 border p-10 bg-primary mx-auto">
            <img
            src={plus}
      ...
      >
        ...
        {/* Advert Title */}
        <section id="hero-text" className="mx-auto max-w-fit text-center">
